...
func (x *StreamResponse) GetExecControl() *StreamResponse_Control {
	if x != nil {
		if x, ok := x.xxx_hidden_Response.(*streamResponse_ExecControl); ok {
...
func (x *StreamResponse) SetExecControl(v *StreamResponse_Control) {
	if v == nil {
		x.xxx_hidden_Response = nil
		return
	}
	x.xxx_hidden_Response = &streamResponse_ExecControl{v}
}
...
func (x *StreamResponse) HasExecControl() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Response.(*streamResponse_ExecControl)
	return ok
}
...
func (x *StreamResponse) ClearExecControl() {
	if _, ok := x.xxx_hidden_Response.(*streamResponse_ExecControl); ok {
		x.xxx_hidden_Response = nil
	}
}
...
const StreamResponse_ExecControl_case case_StreamResponse_Response = 3
...
func (x *StreamResponse) WhichResponse() case_StreamResponse_Response {
	...
	case *streamResponse_ExecControl:
		return StreamResponse_ExecControl_case
	default:
		return StreamResponse_Response_not_set_case
	}
}
...
type StreamResponse_builder struct {
	...
	ExecControl  *StreamResponse_Control
...
func (b0 StreamResponse_builder) Build() *StreamResponse {
	...
	if b.ExecControl != nil {
		x.xxx_hidden_Response = &streamResponse_ExecControl{b.ExecControl}
	}
	return m0
}
...
type streamResponse_ExecControl struct {
	ExecControl *StreamResponse_Control `protobuf:"bytes,3,opt,name=execControl,oneof"`
}
...
func (*streamResponse_ExecControl) isStreamResponse_Response() {}
...
type StreamResponse_Control struct {
	state                protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RequestId string                 `protobuf:"bytes,1,opt,name=requestId"`
	xxx_hidden_Index     uint32                 `protobuf:"varint,2,opt,name=index"`
	xxx_hidden_TurnId    uint64                 `protobuf:"varint,3,opt,name=turnId"`
	xxx_hidden_Type      string                 `protobuf:"bytes,4,opt,name=type"`
	xxx_hidden_MoveCpu   uint64                 `protobuf:"varint,5,opt,name=moveCpu"`
	xxx_hidden_TotalCpu  uint64                 `protobuf:"varint,6,opt,name=totalCpu"`
	xxx_hidden_WallTime  uint64                 `protobuf:"varint,7,opt,name=wallTime"`
	xxx_hidden_Output    []byte                 `protobuf:"bytes,8,opt,name=output"`
	xxx_hidden_Error     string                 `protobuf:"bytes,9,opt,name=error"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}

func (x *StreamResponse_Control) Reset() {
	*x = StreamResponse_Control{}
	mi := &file_stream_response_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StreamResponse_Control) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreamResponse_Control) ProtoMessage() {}

func (x *StreamResponse_Control) ProtoReflect() protoreflect.Message {
	mi := &file_stream_response_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *StreamResponse_Control) GetRequestId() string {
	if x != nil {
...
func (x *StreamResponse_Control) GetIndex() uint32 {
	if x != nil {
		return x.xxx_hidden_Index
	}
	return 0
...
func (x *StreamResponse_Control) GetTurnId() uint64 {
	if x != nil {
...
func (x *StreamResponse_Control) GetType() string {
	if x != nil {
...
func (x *StreamResponse_Control) GetMoveCpu() uint64 {
	if x != nil {
		return x.xxx_hidden_MoveCpu
	}
	return 0
}

func (x *StreamResponse_Control) GetTotalCpu() uint64 {
	if x != nil {
		return x.xxx_hidden_TotalCpu
	}
	return 0
}

func (x *StreamResponse_Control) GetWallTime() uint64 {
	if x != nil {
		return x.xxx_hidden_WallTime
	}
	return 0
}

func (x *StreamResponse_Control) GetOutput() []byte {
	if x != nil {
...
func (x *StreamResponse_Control) GetError() string {
	if x != nil {
...
func (x *StreamResponse_Control) SetRequestId(v string) {
	x.xxx_hidden_RequestId = v
}

func (x *StreamResponse_Control) SetIndex(v uint32) {
	x.xxx_hidden_Index = v
}

func (x *StreamResponse_Control) SetTurnId(v uint64) {
	x.xxx_hidden_TurnId = v
}

func (x *StreamResponse_Control) SetType(v string) {
	x.xxx_hidden_Type = v
}

func (x *StreamResponse_Control) SetMoveCpu(v uint64) {
	x.xxx_hidden_MoveCpu = v
}

func (x *StreamResponse_Control) SetTotalCpu(v uint64) {
	x.xxx_hidden_TotalCpu = v
}

func (x *StreamResponse_Control) SetWallTime(v uint64) {
	x.xxx_hidden_WallTime = v
}

func (x *StreamResponse_Control) SetOutput(v []byte) {
	if v == nil {
		v = []byte{}
	}
...
func (x *StreamResponse_Control) SetError(v string) {
	x.xxx_hidden_Error = v
}

type StreamResponse_Control_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 StreamResponse_Control_builder) Build() *StreamResponse_Control {
	m0 := &StreamResponse_Control{}
	b, x := &b0, m0
	_, _ = b, x
	...
	x.xxx_hidden_MoveCpu = b.MoveCpu
	x.xxx_hidden_TotalCpu = b.TotalCpu
	x.xxx_hidden_WallTime = b.WallTime
...
const file_stream_response_proto_rawDesc = "" +
	"\n" +
	"\x15stream_response.proto\x12\x02pb\x1a\x0eresponse.proto\x1a!google/protobuf/go_features.proto\"\x83\x04\n" +
	...
	"execOutput\x12>\n" +
	"\vexecControl\x18\x03 \x01(\v2\x1a.pb.StreamResponse.ControlH\x00R\vexecControl\x1aH\n" +
	"\x06Output\x12\x14\n" +
	"\x05index\x18\x01 \x01(\rR\x05index\x12\x0e\n" +
	"\x02fd\x18\x03 \x01(\rR\x02fd\x12\x18\n" +
	"\acontent\x18\x02 \x01(\fR\acontent\x1a\xe9\x01\n" +
	"\aControl\x12\x1c\n" +
	"\trequestId\x18\x01 \x01(\tR\trequestId\x12\x14\n" +
	"\x05index\x18\x02 \x01(\rR\x05index\x12\x16\n" +
	"\x06turnId\x18\x03 \x01(\x04R\x06turnId\x12\x12\n" +
	"\x04type\x18\x04 \x01(\tR\x04type\x12\x18\n" +
	"\amoveCpu\x18\x05 \x01(\x04R\amoveCpu\x12\x1a\n" +
	"\btotalCpu\x18\x06 \x01(\x04R\btotalCpu\x12\x1a\n" +
	"\bwallTime\x18\a \x01(\x04R\bwallTime\x12\x16\n" +
	"\x06output\x18\b \x01(\fR\x06output\x12\x14\n" +
	"\x05error\x18\t \x01(\tR\x05errorB\n" +
	"\n" +
	"\bresponseB)Z\x1dgithub.com/criyle/go-judge/pb\x92\x03\a\xd2>\x02\x10\x03\b\x02b\beditionsp\xe8\a"

var file_stream_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_stream_response_proto_goTypes = []any{
	...
	(*StreamResponse_Control)(nil), // 2: pb.StreamResponse.Control
	(*Response)(nil),               // 3: pb.Response
}
var file_stream_response_proto_depIdxs = []int32{
	3, // 0: pb.StreamResponse.execResponse:type_name -> pb.Response
	1, // 1: pb.StreamResponse.execOutput:type_name -> pb.StreamResponse.Output
	2, // 2: pb.StreamResponse.execControl:type_name -> pb.StreamResponse.Control
...
func file_stream_response_proto_init() {
	...
	file_stream_response_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*streamResponse_ExecControl)(nil),
	}
	type x struct{}
