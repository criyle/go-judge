...
type Request_PipeMap struct {
	...
	xxx_hidden_DisableNoCopy bool                       `protobuf:"varint,6,opt,name=disableNoCopy"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *Request_PipeMap) GetDisableNoCopy() bool {
	if x != nil {
		return x.xxx_hidden_DisableNoCopy
	}
	return false
}
...
func (x *Request_PipeMap) SetDisableNoCopy(v bool) {
	x.xxx_hidden_DisableNoCopy = v
}
...
func (b0 Request_PipeMap_builder) Build() *Request_PipeMap {
	...
	x.xxx_hidden_Name = b.Name
	x.xxx_hidden_Max = b.Max
	x.xxx_hidden_DisableNoCopy = b.DisableNoCopy
	return m0
}
...
const file_request_proto_rawDesc = "" +
	"\n" +
	"\rrequest.proto\x12\x02pb\x1a\x1bgoogle/protobuf/empty.proto\x1a!google/protobuf/go_features.proto\"\xdf\x0e\n" +
	"\aRequest\x12\x1c\n" +
	...
	"\boptional\x18\x02 \x01(\bR\boptional\x1a\xfe\x01\n" +
	"\aPipeMap\x12-\n" +
	...
	"\rdisableNoCopy\x18\x06 \x01(\bR\rdisableNoCopy\x1a1\n" +
	"\tPipeIndex\x12\x14\n" +
